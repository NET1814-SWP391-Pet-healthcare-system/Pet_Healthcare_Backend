    ...
    public class ApplicationDbContext : IdentityDbContext<User>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Appointment>().HasData(
                new Appointment { AppointmentId = 1, CustomerId = "283e003d-77ce-4e8a-876f-db63127169dc", PetId = 1, VetId = "7e3fcb0f-11cd-4945-8d9a-84b6c717f94a", SlotId = 1, ServiceId = 1, Date = DateOnly.Parse("2023-06-15"), TotalCost = 50.00, CancellationDate = null, RefundAmount = null, Rating = null, Comments = null, Status = AppointmentStatus.Booked },
                ...
                new Appointment { AppointmentId = 4, CustomerId = "283e003d-77ce-4e8a-876f-db63127169dc", PetId = 4, VetId = "4f0f8727-ddeb-40b5-92d4-22200c4dbb3d", SlotId = 4, ServiceId = 4, Date = DateOnly.Parse("2023-09-01"), TotalCost = 75.00, CancellationDate = null, RefundAmount = null, Rating = null, Comments = null, Status = AppointmentStatus.Booked },
                new Appointment { AppointmentId = 5, CustomerId = "283e003d-77ce-4e8a-876f-db63127169dc", PetId = 5, VetId = "7e3fcb0f-11cd-4945-8d9a-84b6c717f94a", SlotId = 5, ServiceId = 1, Date = DateOnly.Parse("2023-10-15"), TotalCost = 50.00, CancellationDate = null, RefundAmount = null, Rating = null, Comments = null, Status = AppointmentStatus.Booked }
            );
