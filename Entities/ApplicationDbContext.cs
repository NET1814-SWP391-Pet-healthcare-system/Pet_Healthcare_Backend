    ...
    public class ApplicationDbContext : IdentityDbContext<User>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Appointment>().HasData(
                ...
                new Appointment { AppointmentId = 5, CustomerId = "283e003d-77ce-4e8a-876f-db63127169dc", PetId = 5, VetId = "7e3fcb0f-11cd-4945-8d9a-84b6c717f94a", SlotId = 5, ServiceId = 1, Date = DateOnly.Parse("2023-10-15"), TotalCost = 500.00, CancellationDate = null, RefundAmount = null, Rating = null, Comments = null, Status = AppointmentStatus.Boooked }
            );
